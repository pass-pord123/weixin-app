      ...
      for (var _key10 in rawCurrentProps) {
        ...
        (kebabKey = hyphenate(_key10)) === _key10 || !hasOwn(rawProps, kebabKey))) {
          if (options) {
            ...
            rawPrevProps[_key10] !== undefined || // for kebab-case
            rawPrevProps[kebabKey] !== undefined)) {
              props[_key10] = resolvePropValue(options, rawCurrentProps, _key10, undefined, instance, true
              /* isAbsent */
              );
            }
          } else {
  ...
  function createAppAPI(render, hydrate) {
    return function createApp(rootComponent) {
      ...
      var app = context.app = {
        ...
        use(plugin) {
          for (var _len7 = arguments.length, options = new Array(_len7 > 1 ? _len7 - 1 : 0), _key13 = 1; _key13 < _len7; _key13++) {
