...
import { appid, debug, networkTimeout, router, async, sdkConfigs, qqMapKey, googleMapKey, nvue, locale, fallbackLocale } from './${uni_cli_shared_1.MANIFEST_JSON_JS}'
...
function generatePageRoute({ path, meta }, _config) {
  ...
  component:{setup(){return ()=>renderPage(${(0, uni_cli_shared_1.normalizeIdentifier)(path)})}},
