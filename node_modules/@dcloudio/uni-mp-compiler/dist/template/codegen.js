...
function generate({ children }, { slot, event, scopeId, emitFile, filename, directive, lazyElement, isBuiltInComponent, component, }) {
    const context = {
        slot,
        event,
        code: '',
...
function genNode(node, context) {
    switch (node.type) {
        ...
        case 1 /* ELEMENT */:
            if (node.tagType === 2 /* SLOT */) {
                return genSlot(node, context);
            }
            else if (node.tagType === 1 /* COMPONENT */) {
                return genComponent(node, context);
            }
            else if (node.tagType === 3 /* TEMPLATE */) {
...
function genSlot(node, context) {
    ...
    node.props = node.props.filter((prop) => {
        ...
        else if (((_a = prop.arg) === null || _a === void 0 ? void 0 : _a.type) === 4 /* SIMPLE_EXPRESSION */) {
    ...
    genVIf(`$slots.` +
        ((nameProp === null || nameProp === void 0 ? void 0 : nameProp.type) === 6 /* ATTRIBUTE */ && ((_a = nameProp.value) === null || _a === void 0 ? void 0 : _a.content)
            ? nameProp.value.content
            : uni_shared_1.SLOT_DEFAULT_NAME), context);
    push(`>`);
...
function genComponent(node, context) {
    var _a;
    if ((_a = context.component) === null || _a === void 0 ? void 0 : _a.getPropertySync) {
        return genElement(node, context);
    }
...
function isLazyElement(node, context) {
    ...
    return node.props.some((prop) => prop.type === 7 /* DIRECTIVE */ &&
...
function genElementProps(node, context) {
...
function genOn(prop, node, { push, event, isBuiltInComponent }) {
    ...
    const name = ((event === null || event === void 0 ? void 0 : event.format) || uni_cli_shared_1.formatMiniProgramEvent)(arg, {
...
function genDirectiveNode(prop, node, context) {
