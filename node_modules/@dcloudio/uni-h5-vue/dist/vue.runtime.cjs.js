...
const KeepAliveImpl = {
    ...
    setup(props, { slots }) {
        ...
        if (props.cache && props.max) {
            // fixed by xxxxxx
            warn$1('The `max` prop will be ignored if you provide a custom caching strategy');
        }
        ...
        sharedContext.activate = (vnode, container, anchor, isSVG, optimized) => {
            ...
            if (instance.ba) {
                ...
                shared.invokeArrayFns(instance.ba);
            ...
            cache.forEach((cached, key) => {
                ...
                if (cached.type === vnode.type &&
                    ...
                    if (vnode.component.bda) {
                        shared.invokeArrayFns(vnode.component.bda);
                    }
...
function getMatchingName(vnode, matchBy) {
    if (matchBy === 'name') {
        const comp = vnode.type;
        return getComponentName(isAsyncWrapper(vnode)
...
(!exports.isInSSRComponentSetup || lifecycle === "sp" /* SERVER_PREFETCH */) &&
...
function resolveAsset(type, name, warnMissing = true, maybeSelfReference = false) {
    ...
    if (instance) {
        ...
        warn$1(`resolve${shared.capitalize(type.slice(0, -1))} ` +
...
const normalizeRef = ({ ref, ref_key, ref_for }) => {
    return (ref != null
        ? shared.isString(ref) || isRef(ref) || shared.isFunction(ref)
...
const computed$1 = ((getterOrOptions, debugOptions) => {
    // @ts-ignore
    return computed(getterOrOptions, debugOptions, exports.isInSSRComponentSetup);
});
...
function createInvoker(initialValue, instance) {
    const invoker = (e) => {
        ...
        if (skipTimestampCheck || timeStamp >= invoker.attached - 1) {
            ...
            const { value } = invoker;
            if (normalizeNativeEvent && shared.isArray(value)) {
...
class VueElement extends BaseClass {
    ...
    _createVNode() {
        const vnode = createVNode(this._def, shared.extend({}, this._props));
        if (!this._instance) {
            vnode.ce = instance => {
...
const TransitionPropsValidators = (Transition.props =
    /*#__PURE__*/ shared.extend({}, BaseTransition.props, DOMTransitionPropsValidators));
/**
