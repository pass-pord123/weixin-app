            ...
            return {
                resolve: {
                    alias: {
                        ...
                        'vue-i18n': path_1.default.resolve(__dirname, '../../lib/vue-i18n'),
                        ...alias,
                    },
...
function rewriteCompileScript() {
    ...
    compiler.compileScript = (sfc, options) => {
        var _a;
        if ((_a = options === null || options === void 0 ? void 0 : options.templateOptions) === null || _a === void 0 ? void 0 : _a.compilerOptions) {
            ;
